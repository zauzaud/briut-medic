...
import { faBox, faCalendarAlt, faUsers, faMoneyBillWave, faHandPaper, faUserInjured, faNotesMedical, faCog } from '@fortawesome/free-solid-svg-icons';
...
function NavBar() {
    const menuItems = [
        ...
        { icon: faCog, text: "Serviços", to: "/servicos" }, 
    ];
